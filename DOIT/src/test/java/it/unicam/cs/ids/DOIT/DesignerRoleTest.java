...
class DesignerRoleTest {
    ...
    void testGetProjects() {
        try {
            assertTrue(resourceHandler.search(IProject.class, user1.getRole(IDesignerRole.class).getTeams(category1))
                    .contains(project1));
            assertFalse(resourceHandler.search(IProject.class, user1.getRole(IDesignerRole.class).getTeams(category1))
                    .contains(project2));
        } catch (Exception e) {
            e.printStackTrace();
        }
